...
class Directories{
    ...
    public:
        Directories(const string &newDir){
            dirs.push_back(newDir);
            // TODO: default to scanDirs automatically or conditionally
            // TODO: store all scanned directories in config or library file
        }
        void scanDirs(){
...
class Media{
    ...
    public:
        Media(const int &newPlayPos=0){ // argument when called with a pos that was stored in config or library file
            posIn=0;
            playPos=newPlayPos;
        }
        ...
        void playMedia(){
            ...
            while(play){ // TODO: handle exiting/quitting
                ...
                // TODO: set short delay to check for user input
            }
